...
[Government of Canada's Open Data website]
...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#fig-pop1}

We can see from @fig-pop1 that Ontario, Saskatchewan and Alberta 
...
We present the standard deviations in @tbl-sd1.
...
Additionally, note that in @tbl-sd1 we consider the sample standard deviation of the number of horses during the same time span as @fig-pop1.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-pop2 width="65%"}
